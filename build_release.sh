...
RELEA="$ROOT/Release/Konclude-$revisionTagName-$revisionCount-Linux-Docker-x64-GCC4.8.4-Static-Qt5.12.10"
mkdir "$RELEA"
mkdir "$RELEA/Configs"
mkdir "$RELEA/Tests"
...
releaseZipName="Konclude-$revisionTagName-$revisionCount-Linux-Docker-x64-GCC4.8.4-Static-Qt5.12.10"
